  ...
  union() {
    ...
    difference() {
      ...
      for (i = [0:number_of_slots - 1]) {
        ...
        // User requested slot Z-start at 16 (20mm deep from top of 36mm block)
        // Internal slot_cutout has a -1 translation, so we translate to 17
        translate([x_pos, total_depth - display_block_depth + y_pos, 17])
